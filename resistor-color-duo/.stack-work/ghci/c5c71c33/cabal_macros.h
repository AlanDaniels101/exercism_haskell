...
/* package resistor-color-duo-2.0.0.1 */
#ifndef VERSION_resistor_color_duo
#define VERSION_resistor_color_duo "2.0.0.1"
#endif /* VERSION_resistor_color_duo */
#ifndef MIN_VERSION_resistor_color_duo
#define MIN_VERSION_resistor_color_duo(major1,major2,minor) (\
  (major1) <  2 || \
  (major1) == 2 && (major2) <  0 || \
  (major1) == 2 && (major2) == 0 && (minor) <= 0)
#endif /* MIN_VERSION_resistor_color_duo */
...
#define CURRENT_PACKAGE_KEY "resistor-color-duo-2.0.0.1-JnuHGTitm4pKrPcEuhbunG"
#endif /* CURRENT_PACKAGE_KEY */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "resistor-color-duo-2.0.0.1-JnuHGTitm4pKrPcEuhbunG"
#endif /* CURRENT_COMPONENT_ID */
#ifndef CURRENT_PACKAGE_VERSION
#define CURRENT_PACKAGE_VERSION "2.0.0.1"
