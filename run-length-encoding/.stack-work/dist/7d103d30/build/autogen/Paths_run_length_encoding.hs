...
libdir     = "C:\\Users\\aland\\Exercism\\haskell\\run-length-encoding\\.stack-work\\install\\dbe016db\\lib\\x86_64-windows-ghc-8.4.3\\run-length-encoding-1.1.0.5-8sQejL3XtLXAjQan3qLQvD"
