...
/* package run-length-encoding-1.1.0.5 */
#ifndef VERSION_run_length_encoding
#define VERSION_run_length_encoding "1.1.0.5"
#endif /* VERSION_run_length_encoding */
#ifndef MIN_VERSION_run_length_encoding
#define MIN_VERSION_run_length_encoding(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  1 || \
  (major1) == 1 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_run_length_encoding */
...
#define CURRENT_PACKAGE_KEY "run-length-encoding-1.1.0.5-8sQejL3XtLXAjQan3qLQvD"
#endif /* CURRENT_PACKAGE_KEY */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "run-length-encoding-1.1.0.5-8sQejL3XtLXAjQan3qLQvD"
