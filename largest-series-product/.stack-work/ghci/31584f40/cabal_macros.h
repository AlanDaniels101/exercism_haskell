...
/* package largest-series-product-1.2.0.6 */
#ifndef VERSION_largest_series_product
#define VERSION_largest_series_product "1.2.0.6"
#endif /* VERSION_largest_series_product */
#ifndef MIN_VERSION_largest_series_product
#define MIN_VERSION_largest_series_product(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  2 || \
  (major1) == 1 && (major2) == 2 && (minor) <= 0)
#endif /* MIN_VERSION_largest_series_product */
...
#define CURRENT_PACKAGE_KEY "largest-series-product-1.2.0.6-FjLwq3sGHuWA5lpwW6djT7"
#endif /* CURRENT_PACKAGE_KEY */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "largest-series-product-1.2.0.6-FjLwq3sGHuWA5lpwW6djT7"
