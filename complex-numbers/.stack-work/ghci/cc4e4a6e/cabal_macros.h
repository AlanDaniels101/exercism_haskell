...
/* package complex-numbers-1.3.0.6 */
#ifndef VERSION_complex_numbers
#define VERSION_complex_numbers "1.3.0.6"
#endif /* VERSION_complex_numbers */
#ifndef MIN_VERSION_complex_numbers
#define MIN_VERSION_complex_numbers(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  3 || \
  (major1) == 1 && (major2) == 3 && (minor) <= 0)
#endif /* MIN_VERSION_complex_numbers */
...
#define CURRENT_PACKAGE_KEY "complex-numbers-1.3.0.6-HIJz4JFqQJqBv4mQmwNunT"
#endif /* CURRENT_PACKAGE_KEY */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "complex-numbers-1.3.0.6-HIJz4JFqQJqBv4mQmwNunT"
