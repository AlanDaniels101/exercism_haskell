...
/* package pythagorean-triplet-1.0.0.4 */
#ifndef VERSION_pythagorean_triplet
#define VERSION_pythagorean_triplet "1.0.0.4"
#endif /* VERSION_pythagorean_triplet */
#ifndef MIN_VERSION_pythagorean_triplet
#define MIN_VERSION_pythagorean_triplet(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  0 || \
  (major1) == 1 && (major2) == 0 && (minor) <= 0)
#endif /* MIN_VERSION_pythagorean_triplet */

/* package arithmoi-0.7.0.0 */
#ifndef VERSION_arithmoi
#define VERSION_arithmoi "0.7.0.0"
...
#define CURRENT_PACKAGE_KEY "pythagorean-triplet-1.0.0.4-FNDJslWYpNU3jHyJzjnkWR"
#endif /* CURRENT_PACKAGE_KEY */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "pythagorean-triplet-1.0.0.4-FNDJslWYpNU3jHyJzjnkWR"
