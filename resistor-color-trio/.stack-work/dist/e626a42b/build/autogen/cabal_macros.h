...
/* package resistor-color-trio-1.0.0.0 */
#ifndef VERSION_resistor_color_trio
#define VERSION_resistor_color_trio "1.0.0.0"
#endif /* VERSION_resistor_color_trio */
#ifndef MIN_VERSION_resistor_color_trio
#define MIN_VERSION_resistor_color_trio(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  0 || \
  (major1) == 1 && (major2) == 0 && (minor) <= 0)
#endif /* MIN_VERSION_resistor_color_trio */
...
#define CURRENT_PACKAGE_KEY "resistor-color-trio-1.0.0.0-LDN9kvL85k8Dzl4VWBpD95"
#endif /* CURRENT_PACKAGE_KEY */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "resistor-color-trio-1.0.0.0-LDN9kvL85k8Dzl4VWBpD95"
