...
/* package simple-linked-list-0.1.0.3 */
#ifndef VERSION_simple_linked_list
#define VERSION_simple_linked_list "0.1.0.3"
#endif /* VERSION_simple_linked_list */
#ifndef MIN_VERSION_simple_linked_list
#define MIN_VERSION_simple_linked_list(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_simple_linked_list */
...
#define CURRENT_PACKAGE_KEY "simple-linked-list-0.1.0.3-CvuzPIhnJfeDtLaXt1cVHp"
#endif /* CURRENT_PACKAGE_KEY */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "simple-linked-list-0.1.0.3-CvuzPIhnJfeDtLaXt1cVHp"
