...
/* package house-0.1.0.3 */
#ifndef VERSION_house
#define VERSION_house "0.1.0.3"
#endif /* VERSION_house */
#ifndef MIN_VERSION_house
#define MIN_VERSION_house(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_house */
...
#define CURRENT_PACKAGE_KEY "house-0.1.0.3-FyWrXSNbzh7JHcrq6db9Am"
#endif /* CURRENT_PACKAGE_KEY */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "house-0.1.0.3-FyWrXSNbzh7JHcrq6db9Am"
